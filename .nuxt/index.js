...
import nuxt_plugin_plugin_bc01bd0a from 'nuxt_plugin_plugin_bc01bd0a' // Source: ./components/plugin.js (mode: 'all')
import nuxt_plugin_pluginrouting_b8f1efd6 from 'nuxt_plugin_pluginrouting_b8f1efd6' // Source: ./nuxt-i18n/plugin.routing.js (mode: 'all')
import nuxt_plugin_pluginmain_b9f8390c from 'nuxt_plugin_pluginmain_b9f8390c' // Source: ./nuxt-i18n/plugin.main.js (mode: 'all')
import nuxt_plugin_bootstrapvue_7beaaa40 from 'nuxt_plugin_bootstrapvue_7beaaa40' // Source: ./bootstrap-vue.js (mode: 'all')
...
import nuxt_plugin_tour_b99d772e from 'nuxt_plugin_tour_b99d772e' // Source: ../plugins/tour.js (mode: 'all')
...
async function createApp(ssrContext, config = {}) {
  ...
  if (typeof nuxt_plugin_plugin_bc01bd0a === 'function') {
    await nuxt_plugin_plugin_bc01bd0a(app.context, inject)
  }

  if (typeof nuxt_plugin_pluginrouting_b8f1efd6 === 'function') {
    await nuxt_plugin_pluginrouting_b8f1efd6(app.context, inject)
  }

  if (typeof nuxt_plugin_pluginmain_b9f8390c === 'function') {
    await nuxt_plugin_pluginmain_b9f8390c(app.context, inject)
  }

  if (typeof nuxt_plugin_bootstrapvue_7beaaa40 === 'function') {
    await nuxt_plugin_bootstrapvue_7beaaa40(app.context, inject)
  }
